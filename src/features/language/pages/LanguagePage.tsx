    ...
    <>
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white tracking-tight">Idiomas</h1>
            <p className="mt-1 text-gray-500 dark:text-zinc-400 text-sm">Administra los idiomas de tu portafolio.</p>
          </div>
