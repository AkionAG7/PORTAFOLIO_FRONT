    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-zinc-400 text-sm">Gestiona los idiomas de tu portafolio.</p>
        </div>
      ...
      <div className="flex flex-col items-center justify-center py-20 gap-4 bg-zinc-900 border border-zinc-800 rounded-2xl">
        ...
        <div className="text-center">
          <p className="text-zinc-300 font-medium">Sin idiomas aún</p>
          <p className="text-zinc-500 text-sm mt-1">Agrega los idiomas que hablas.</p>
        </div>
      </div>
    </div>
  )
