    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={onClose}>
      <div className="w-full max-w-md bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-2xl shadow-2xl flex flex-col" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-gray-200 dark:border-zinc-800">
          <h2 className="text-gray-900 dark:text-white font-semibold text-lg">Nuevo contacto</h2>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5 px-6 py-6">
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="contact-name" className="text-sm font-medium text-gray-600 dark:text-zinc-300">Nombre</label>
            <input
              id="contact-name"
              type="text"
              required
          ...
          {/* Link */}
          <div className="flex flex-col gap-2">
            <label htmlFor="contact-link" className="text-sm font-medium text-gray-600 dark:text-zinc-300">Enlace</label>
            <input
              id="contact-link"
              type="url"
              required
          ...
          <div className="flex flex-col gap-2">
            ...
            {preview ? (
              <div className="flex items-center gap-3 p-3 bg-gray-100 dark:bg-zinc-800 border border-gray-300 dark:border-zinc-700 rounded-xl">
                ...
                <span className="text-gray-600 dark:text-zinc-300 text-sm truncate flex-1">{imageFile?.name}</span>
                <button
                  type="button"
